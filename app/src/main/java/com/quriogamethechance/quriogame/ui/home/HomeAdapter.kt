...
class HomeAdapter(private var list : List<HomeData>):RecyclerView.Adapter<HomeAdapter.BaseViewHolder>() {
        ...
        viewType: Int
         ...
         return when(viewType){
            HomeItemType.USER_INFORMATION.ordinal -> {
                val view = LayoutInflater.from(parent.context).inflate(R.layout.item_user_information,parent,false)
            ...
            HomeItemType.TRACKING_LOGIN.ordinal -> {
                val view = LayoutInflater.from(parent.context).inflate(R.layout.item_tracking_login,parent,false)
