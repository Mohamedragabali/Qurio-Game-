...
class SecondOnboardingFragment : BaseFragment<FragmentSecondOnboardingBinding>() , OnboardingViewInterface{
    ...
    private fun initialButton() {
        ...
        binding.nextButton.setOnClickListener {
            val action = SecondOnboardingFragmentDirections.actionSecondOnboardingFragmentToThirdOnboardingFragment()
                ...
                when (event.action) {
                    ...
                    MotionEvent.ACTION_UP -> {
                        if (v.y <= 50f) {
                            ...
                            val action =
                                SecondOnboardingFragmentDirections.actionSecondOnboardingFragmentToHomeFragment()
